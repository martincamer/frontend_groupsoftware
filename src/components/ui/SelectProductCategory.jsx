...
export const SelectProductCategory = () => {
  ...
  return (
    <select
      className="bg-white border-[1px] border-gray-300 rounded-md shadow-black/20 shadow-md py-3 font-bold px-3 w-[480px] placeholder:text-gray-500/90 outline-none uppercase"
